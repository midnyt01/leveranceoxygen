    ...
    <div>
      <div className='sidenav'>
        <ul className='slideout'>
          ...
          <li>
              <Link to='/return-orders' className='decoration-none primary-text place-return-order-sidenav'
            ...
            <li>
              <Link to='/seller-analytics' className='decoration-none primary-text'>
              <span className='mr-2 f-size-1'><FontAwesomeIcon icon="fa-solid fa-chart-line" /></span>Sales
              </Link>
            </li>
            <li>
              <Link to='/confirm-orders' className='decoration-none primary-text'>
              <span className='mr-2 f-size-1'><FontAwesomeIcon icon="fa-solid fa-chart-line" /></span>Confirm Orders
              </Link>
            </li>
            <li>
              <Link to='/return-orders' className='decoration-none primary-text'>
